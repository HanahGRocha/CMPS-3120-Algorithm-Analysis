#include <stdio.h> //fill in lines 95 and 111
#include <stdlib.h>

#define EVEN 0
#define ODD 1

//Add the five lines of code as stated in lab9.pdf
#define OR 1
#define XOR 0
